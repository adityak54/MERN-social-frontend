...
import AddEdit from "../components/CRUD";
      ...
      <nav className="bg-blue-800 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <button
            ...
            className="text-blue-200 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
          >
            Log Out
          </button>
        </div>
      ...
      <div className="fixed bottom-0 w-full">
        {state === "add" || state === "edit" ? (
          ...
          <button
            ...
            className="bg-red-600 hover:bg-blue-700  fixed bottom-4 right-5 text-white font-bold py-2 px-4 rounded border
          "
          >
            Create a Post
          </button>
